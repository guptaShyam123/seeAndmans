...
import Ourpackage from "../packeges/Ourpackage";
    ...
    <>
      <Bigimage>
        <center>
          <Maindiv>
            ...
            <Cruise>
              <Img4 src={greencruise} />

              <Para3 style={{ color: "#31FFC1" }}>Tour Packages</Para3>
            </Cruise>
      ...
      <center>
        <Greens>
          ...
          <Second1>
           <img src={raja} />
          <Selectdivs1 onClick={inputclick}  type="text" placeholder="  1 Room & 3 Children" readonly  value={`${stateinput3} No Of days`}/>
            </Second1>
            </Second>
          {
            show &&   <Maindropss>
      ...
      <center>
        {" "}
        <Button style={{ cursor: "pointer" }} onClick={clicks}>
          {" "}
          <p>Search </p>{" "}
        </Button>
      </center>
        ...
        <Bigdiv>
          ...
          >
            {datas?.activity?.map((item) => {
              return (
                <>
                  <Maindiv1 style={{cursor:'pointer'}}  onClick={() => Handleclick(`/scubadetail/${item._id}`)}>
                    <Img11 src={item.image?.url} />
                    <Innerdivs>
                      <Map src={map} />
