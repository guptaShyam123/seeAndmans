...
const navigate = useNavigate()
 ...
 <center>
 <Maindiv>
   <Link to="/" style={{textDecoration:'none'}}> <Hotels   >
       <Img11    src={hotel}  />
   ...
   <Img2 src={greencab} />
     ...
     <Para1 style={{color:'#31FFC1'}} >Cabs</Para1>
    
    </Cabs1>
    
  
    
    <Link to="/ferry" style={{textDecoration:'none'}}> <Ferries   >
       <Img3  src={ferries} />
    ...
    <Link to="/cruise" style={{textDecoration:'none'}}> <Cruise>
