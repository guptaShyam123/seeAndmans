...
import mobile1 from "../../assets/mobilecab2.avif"
import hotel1 from '../../assets/hotelStar.svg'
import cab1 from '../../assets/London.svg'
   ...
   <>
     ...
     <center>
      ...
      <div style={{width:"100%" , textAlign:"left"}}>
         ...
         <div style={{width:"100%" , textAlign:"left"}}>
         <span style={{color:"white"  , textAlign:"left" , width:"100%" , fontWeight:"700"}}>calender</span>
      <div className={styles.locationwrapper}>
      ...
      <span style={{color:"white"  , textAlign:"left" , width:"100%" , fontWeight:"700"}}>Travellers</span>
      <div className={styles.locationwrapper}>
      <MdLocationOn   className={styles.locationIcon} style={{ marginRight:"6px"}} />
      <input name="" id="" className={styles.select}  onClick={handleClickOpen}  type="text" placeholder=" " readonly  value={`${stateinput3} Trvaellers`}/>
